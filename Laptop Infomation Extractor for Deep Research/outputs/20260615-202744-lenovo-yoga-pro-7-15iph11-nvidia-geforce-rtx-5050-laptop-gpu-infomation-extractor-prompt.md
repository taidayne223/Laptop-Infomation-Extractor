...
| System SKU/version | Yoga Pro 7 15IPH11 |
...
| RAM | 31.5 GB |
| Storage devices | MSI DATAMAG 20Gbps SCSI Disk Device, SAMSUNG MZAL81T0HFLB-00BL2, NVMe SAMSUNG MZAL81T0, MSI DATAMAG 20Gbps |
| Display / panel | name: R241Y, manufacturer_id: ACR, product_code: 0x0521, physical_size: 53 x 30 cm (~24 in), native_or_preferred_resolution: 1920 x 1080, estimated_refresh_rate: 75 Hz, refresh_range: 48-76 Hz, horizontal_scan_range: 31-84 kHz, registry_hint: ACR0521; name: EF25QBA63.B, manufacturer_id: EDO, product_code: 0x3015, physical_size: 33 x 20 cm (~15.2 in), refresh_range: 48-165 Hz, horizontal_scan_range: 46-47 kHz, registry_hint: EDO3015, current_desktop_resolution: 2560 x 1600, primary: True, active_refresh_rate: 165 Hz, estimated_refresh_rate: 165 Hz, native_or_preferred_resolution: 2560 x 1600 |
| Battery | id: L23N4PF1, manufacturer: ATL, chemistry: LiP, design_capacity: 84.0 Wh, full_charge_capacity: 87.0 Wh, cycle_count: 3, estimated_active_runtime_design: 8h 48m, estimated_active_runtime_full_charge: 9h 7m |
...
|---|---|---:|---:|---|
| C:\ | Fixed | 951.5 GB | 750.1 GB | Windows-SSD |
| D:\ | Fixed | 931.5 GB | 426.4 GB | MSI DATAMAG |

### Local Displays

| Name | Manufacturer ID | Product code | Physical size | Native/preferred resolution | Current resolution | Refresh | Active refresh | Display Type | Main | Registry hint |
|---|---|---|---|---|---|---|---|---|---|---|
| R241Y | ACR | 0x0521 | 53 x 30 cm (~24 in) | 1920 x 1080 |  | 75 Hz |  |  |  | ACR0521 |
| EF25QBA63.B | EDO | 0x3015 | 33 x 20 cm (~15.2 in) | 2560 x 1600 | 2560 x 1600 | 165 Hz | 165 Hz |  |  | EDO3015 |

### Local Battery

| ID / Device Name | Manufacturer | Chemistry | Design capacity | Full charge/Max capacity | Cycle count | Health / State | Est. Active Runtime (Design) | Est. Active Runtime (Full) | Charger Wattage |
|---|---|---|---|---|---|---|---|---|---|
| L23N4PF1 | ATL | LiP | 84.0 Wh | 87.0 Wh | 3 |  | 8h 48m | 9h 7m |  |
...
- SKU/version: Yoga Pro 7 15IPH11
- Baseboard: LNVNB161216
- CPU: Intel(R) Core(TM) Ultra 7 356H
- Alternatives/hints:
