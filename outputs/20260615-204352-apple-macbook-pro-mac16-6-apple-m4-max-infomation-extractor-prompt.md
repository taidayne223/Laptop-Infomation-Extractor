...
- Confirmed / detected laptop model: `Apple MacBook Pro Mac16,6`
- Confirmed / detected GPU variant: `Apple M4 Max`

## Extracted Clean Specs

| Field | Local extracted value |
|---|---|
| Confirmed model | Apple MacBook Pro Mac16,6 |
| Manufacturer | Apple |
| Marketing model | Unknown |
| Product/model code | MacBook Pro |
| System SKU/version | Mac16,6 |
| Baseboard | Unknown |
| BIOS version | Unknown |
| CPU | Apple M4 Max |
| Confirmed GPU variant | Apple M4 Max |
| Detected GPU list | Apple M4 Max, sppci_vendor_Apple |
| RAM | 64 GB |
| Storage devices | Unknown |
| Display / panel | name: BenQ MA270S, native_or_preferred_resolution: 2560 x 1440 @ 60.00Hz, main: spdisplays_yes; name: Color LCD, native_or_preferred_resolution: 1800 x 1169 @ 120.00Hz, display_type: spdisplays_built-in-liquid-retina-xdr |
| Battery | charger_wattage: 98 W |
...
|---|---|---|---|---|---|---|---|---|---|---|
| BenQ MA270S |  |  |  | 2560 x 1440 @ 60.00Hz |  |  |  |  | spdisplays_yes |  |
| Color LCD |  |  |  | 1800 x 1169 @ 120.00Hz |  |  |  | spdisplays_built-in-liquid-retina-xdr |  |  |
